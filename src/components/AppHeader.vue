<template>
  <header class="flex items-center h-16 px-4 sticky top-0 bg-white z-20 shadow">
    ...
    <div class="hidden mx-auto sm:flex items-center text-white bg-primary-dark px-3">
      ...
      <span class="text-md font-medium tracking-wider ml-2">Free shipping for orders over $1000</span>
    </div>
