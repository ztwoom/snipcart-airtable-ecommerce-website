<template>
	<header class="flex items-center h-16 px-4 sticky top-0 bg-white z-20 shadow">
			...
			>
				...
				<g id="Layer_2" data-name="Layer 2">
					<g id="Layer_1-2" data-name="Layer 1">
						...
						<path
							id="path40771"
							d="M345.34,55.75V80.59H362.8V76.26H350V55.75Z"
							style="fill:#ccc"
						/>
						<path
							id="path40773"
						...
						<path
							id="path40792"
							d="M439.27,38.45h7.11V7.22h12V.75h-31V7.22h12Z"
						/>
						<path
							id="path40794"
		...
		<button
			class="snipcart-checkout ml-auto focus:outline-none"
			:class="[itemCount ? 'mr-2' : '']"
		>
			<span
